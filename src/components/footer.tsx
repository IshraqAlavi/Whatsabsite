...
import { integrations, siteConfig } from "@/lib/data"

const footerLinks = {
    products: [
        { name: "Notifyer System", href: "/products/notifyer-system" },
        { name: "Notifier Bot", href: "/products/notifier-bot" },
        { name: "WhatsAble Bot", href: "/products/whatsable-bot" },
    ],
    features: [
        { name: "WhatsApp API", href: "/features/whatsapp-api" },
        { name: "AI Chatbots", href: "/features/ai-chatbots" },
    ...
    integrations: [
        ...
        { name: "REST API", href: "/integrations/api" },
    ],
    resources: [
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-6">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="mt-4 text-sm text-muted-foreground">
                            WhatsApp automation for teams and brands. Connect Zapier, Make, or n8n to send
                            WhatsApp notifications every time something happens in your organization.
                        </p>
                ...
                <div className="mt-12 border-t pt-8">
                    <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
                        <div className="flex flex-wrap items-center justify-center space-x-6 text-sm text-muted-foreground">
                            <span>&copy; 2025 WhatsAble. All rights reserved.</span>
